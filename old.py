...
python ocr.py --action run --input_movie ./input-t/movie.mkv --input_sheet ./input-t/input.xlsx --output_sheet ./input-t2/finals.xlsx --output_frames_dir
 ./output-t2 --aabb 325,70,960,650 --aabb_names 435,70,570,650 --east_detection_threshold=100
